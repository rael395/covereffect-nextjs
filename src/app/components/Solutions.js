        ...
        <div className="lg:flex space-x-2 justify-between">
          ...
          <div className="lg:w-5/12 relative z-10">
            {solutionContent.text.headingSubTitle && (
              <span
                className="inline-block z-10 py-0.5 pl-3 text-heading font-semibold relative mb-7 before:content-[''] before:absolute before:w-2/3 before:bg-yellowLight before:left-0 before:top-0 before:bottom-0 before:z-[-1]"
                data-aos="fade-up"
                data-aos-delay="0">
                {solutionContent.text.headingSubTitle}
              </span>
